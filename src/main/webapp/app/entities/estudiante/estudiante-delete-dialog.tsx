...
export const EstudianteDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ingresosReingresosApp.estudiante.delete.question">
        <Translate contentKey="ingresosReingresosApp.estudiante.delete.question" interpolate={{ id: estudianteEntity.id }}>
