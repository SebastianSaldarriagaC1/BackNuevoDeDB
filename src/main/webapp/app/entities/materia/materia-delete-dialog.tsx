...
export const MateriaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ingresosReingresosApp.materia.delete.question">
        <Translate contentKey="ingresosReingresosApp.materia.delete.question" interpolate={{ id: materiaEntity.id }}>
