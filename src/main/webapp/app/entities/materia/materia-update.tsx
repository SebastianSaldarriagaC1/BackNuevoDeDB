  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ingresosReingresosApp.materia.home.createOrEditLabel" data-cy="MateriaCreateUpdateHeading">
            <Translate contentKey="ingresosReingresosApp.materia.home.createOrEditLabel">Create or edit a Materia</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ingresosReingresosApp.materia.nombreMateria')}
              ...
              />
              <ValidatedField
                label={translate('ingresosReingresosApp.materia.creditos')}
                id="materia-creditos"
                name="creditos"
                data-cy="creditos"
                type="text"
