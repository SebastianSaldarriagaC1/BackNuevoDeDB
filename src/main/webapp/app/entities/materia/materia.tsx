  ...
  return (
    <div>
      <h2 id="materia-heading" data-cy="MateriaHeading">
        <Translate contentKey="ingresosReingresosApp.materia.home.title">Materias</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ingresosReingresosApp.materia.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/materia/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ingresosReingresosApp.materia.home.createLabel">Create new Materia</Translate>
          </Link>
        </div>
      </h2>
        ...
        {materiaList && materiaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="ingresosReingresosApp.materia.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="ingresosReingresosApp.materia.nombreMateria">Nombre Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="ingresosReingresosApp.materia.creditos">Creditos</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ingresosReingresosApp.materia.home.notFound">No Materias found</Translate>
            </div>
          )
        )}
      </div>
