...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MATERIASPENSUM_LIST actions', async () => {
    ...
    it('dispatches FETCH_MATERIASPENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MATERIASPENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MATERIASPENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MATERIASPENSUM actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MATERIASPENSUM actions', async () => {
      const expectedActions = [
        {
