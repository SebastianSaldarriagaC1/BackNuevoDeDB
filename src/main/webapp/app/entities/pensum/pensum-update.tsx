  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ingresosReingresosApp.pensum.home.createOrEditLabel" data-cy="PensumCreateUpdateHeading">
            <Translate contentKey="ingresosReingresosApp.pensum.home.createOrEditLabel">Create or edit a Pensum</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ingresosReingresosApp.pensum.numeroPensum')}
                id="pensum-numeroPensum"
                name="numeroPensum"
                data-cy="numeroPensum"
                type="text"
              />
