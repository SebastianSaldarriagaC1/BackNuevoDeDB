...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './sede.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEDE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEDE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEDE actions', async () => {
      const expectedActions = [
        {
