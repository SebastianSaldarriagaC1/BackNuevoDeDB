...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './solicitud-reingreso.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SOLICITUDREINGRESO_LIST actions', async () => {
    ...
    it('dispatches FETCH_SOLICITUDREINGRESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SOLICITUDREINGRESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SOLICITUDREINGRESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SOLICITUDREINGRESO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SOLICITUDREINGRESO actions', async () => {
      const expectedActions = [
        {
