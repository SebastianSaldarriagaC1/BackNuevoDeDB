...
class MateriaResourceIT {
    ...
    public static Materia createEntity(EntityManager em) {
        Materia materia = new Materia().nombreMateria(DEFAULT_NOMBRE_MATERIA).creditos(DEFAULT_CREDITOS);
        return materia;
    }
    ...
    public static Materia createUpdatedEntity(EntityManager em) {
        Materia materia = new Materia().nombreMateria(UPDATED_NOMBRE_MATERIA).creditos(UPDATED_CREDITOS);
        return materia;
    }
    ...
    void putExistingMateria() throws Exception {
        ...
        updatedMateria.nombreMateria(UPDATED_NOMBRE_MATERIA).creditos(UPDATED_CREDITOS);
    ...
    void partialUpdateMateriaWithPatch() throws Exception {
        ...
        partialUpdatedMateria.nombreMateria(UPDATED_NOMBRE_MATERIA).creditos(UPDATED_CREDITOS);
