...
class SedeResourceIT {
    ...
    private static final String DEFAULT_DIRECCION_SEDE = "AAAAAAAAAA";
    private static final String UPDATED_DIRECCION_SEDE = "BBBBBBBBBB";
    ...
    public static Sede createEntity(EntityManager em) {
        Sede sede = new Sede().nombreSede(DEFAULT_NOMBRE_SEDE).direccionSede(DEFAULT_DIRECCION_SEDE).regional(DEFAULT_REGIONAL);
        return sede;
    }
    ...
    public static Sede createUpdatedEntity(EntityManager em) {
        Sede sede = new Sede().nombreSede(UPDATED_NOMBRE_SEDE).direccionSede(UPDATED_DIRECCION_SEDE).regional(UPDATED_REGIONAL);
        return sede;
    }
    ...
    void createSede() throws Exception {
        ...
        assertThat(testSede.getDireccionSede()).isEqualTo(DEFAULT_DIRECCION_SEDE);
        assertThat(testSede.getRegional()).isEqualTo(DEFAULT_REGIONAL);
    }
    ...
    void getAllSedes() throws Exception {
        ...
        restSedeMockMvc
            ...
            .andExpect(jsonPath("$.[*].direccionSede").value(hasItem(DEFAULT_DIRECCION_SEDE)))
    ...
    void getSede() throws Exception {
        ...
        restSedeMockMvc
            ...
            .andExpect(jsonPath("$.direccionSede").value(DEFAULT_DIRECCION_SEDE))
    ...
    void putExistingSede() throws Exception {
        ...
        updatedSede.nombreSede(UPDATED_NOMBRE_SEDE).direccionSede(UPDATED_DIRECCION_SEDE).regional(UPDATED_REGIONAL);
        ...
        assertThat(testSede.getDireccionSede()).isEqualTo(UPDATED_DIRECCION_SEDE);
        assertThat(testSede.getRegional()).isEqualTo(UPDATED_REGIONAL);
    }
    ...
    void partialUpdateSedeWithPatch() throws Exception {
        ...
        partialUpdatedSede.nombreSede(UPDATED_NOMBRE_SEDE).regional(UPDATED_REGIONAL);
    ...
    void fullUpdateSedeWithPatch() throws Exception {
        ...
        partialUpdatedSede.nombreSede(UPDATED_NOMBRE_SEDE).direccionSede(UPDATED_DIRECCION_SEDE).regional(UPDATED_REGIONAL);
